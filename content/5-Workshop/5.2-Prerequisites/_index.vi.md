...
Đảm bảo tài khoản AWS đã sẵn sàng để triển khai toàn bộ workshop.

## Giải thích dịch vụ

IAM, VPC, S3, CloudTrail, GuardDuty và CloudWatch là những service sẽ được dùng thường xuyên trong workshop này.
